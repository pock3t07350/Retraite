...
.title {{
    text-align:center;
    font-size:140px;   /* 🔥 2x plus gros */
    margin:20px;
}}

/* COMPTEUR */
.number {{
    font-size:220px;   /* 🔥 2x plus gros */
    text-align:center;
    margin:0;
}}

.label {{
    font-size:50px;    /* 🔥 2x plus gros */
    text-align:center;
    opacity:0.9;
}}
...
st.markdown(
    f"<div style='text-align:center;font-size:70px;margin-top:20px;'>"
